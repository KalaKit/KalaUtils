#!/bin/bash
# This script builds KalaUtils from source using g++ and CMake with Unix Makefiles in Release mode on Linux.

# Set the root folder as the location of this script
UTILS_ROOT="$(dirname "$(readlink -f "$0")")"
BUILD_DIR="$UTILS_ROOT/build-release"
INSTALL_DIR="$UTILS_ROOT/install-release"
...
# Configure KalaUtils with CMake using Unix Makefiles
